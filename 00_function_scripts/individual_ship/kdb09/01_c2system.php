<?php
    ...
    $serverrack09 = $connection-> query("SELECT c.id, cn.name, c.c_status, c.c_condition, c.storob, c.remarks
    ...
    $wmfccrack09 = $connection-> query("SELECT c.id, cn.name, c.c_status, c.c_condition, c.storob, c.remarks
    ...
    $radioroom09 = $connection-> query("SELECT c.id, cn.name, c.c_status, c.c_condition, c.storob, c.remarks
    ...
    $wmfc109 = $connection-> query("SELECT c.id, cn.name, c.c_status, c.c_condition, c.storob, c.remarks
    ...
    $wmfc209 = $connection-> query("SELECT c.id, cn.name, c.c_status, c.c_condition, c.storob, c.remarks
    ...
    $lsdsystem09 = $connection-> query("SELECT c.id, cn.name, c.c_status, c.c_condition, c.storob, c.remarks
