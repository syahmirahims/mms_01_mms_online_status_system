<?php
    ...
    $serverrack = $connection-> query("SELECT c.id, cn.name, c.c_status, c.c_condition, c.remarks
    ...
    $mfw1 = $connection-> query("SELECT c.id, cn.name, c.c_status, c.c_condition, c.remarks
    ...
    $mfw2 = $connection-> query("SELECT c.id, cn.name, c.c_status, c.c_condition, c.remarks
