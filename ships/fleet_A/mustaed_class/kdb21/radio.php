...
<html lang="en">
    ...
    <body>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../../00_function_scripts/individual_ship/kdb21/01_radio.php"; 
        ...
        <section>
            <div class="card" id="card3">
                <table>
                    ...
                    <?php while ($radio21row = $radio21-> fetch_assoc()): ?>

                    <tr>
                        <td class="id"><?php echo $radio21row['id']; ?></td>
                        <td class="componentName"><?php echo $radio21row['radio_name']; ?></td>
                        <td class="status"><?php echo $radio21row['r_status']; ?></td>
                        <td class="condition"><?php echo $radio21row['r_condition']; ?></td>
                        <td class="storob"><?php echo $radio21row['storob']; ?></td>
                        <td class="remarks"><?php echo $radio21row['remarks']; ?></td>
