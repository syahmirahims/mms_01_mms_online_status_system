...
<html lang="en">
    ...
    <body>
        <?php require "../../../../00_function_scripts/individual_ship/kdb07/02_radio.php"; ?>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../../00_function_scripts/individual_ship/kdb07/02_radio.php"; 
        ...
        <section>
            <div class="card" id="card3">
                <table>
                    ...
                    <?php while ($radio07row = $radio07-> fetch_assoc()): ?>

                    <tr>
                        <td class="id"><?php echo $radio07row['id']; ?></td>
                        <td class="componentName"><?php echo $radio07row['radio_name']; ?></td>
                        <td class="status"><?php echo $radio07row['r_status']; ?></td>
                        <td class="condition"><?php echo $radio07row['r_condition']; ?></td>
                        <td class="storob"><?php echo $radio07row['storob']; ?></td>
                        <td class="remarks"><?php echo $radio07row['remarks']; ?></td>
