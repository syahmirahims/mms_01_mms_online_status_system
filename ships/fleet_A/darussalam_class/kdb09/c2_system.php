...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../../../../01_stylesheets/08_ships_page/kdb09/02_style_c2system_page.css">
    ...
    <body>
        <?php require "../../../../00_function_scripts/individual_ship/kdb09/01_c2system.php"; ?>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../../00_function_scripts/individual_ship/kdb09/01_c2system.php"; 
        ...
        <section>
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <?php while ($serverrack09row = $serverrack09-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $serverrack09row['id']; ?></td>
                            <td class="componentName"><?php echo $serverrack09row['name']; ?></td>
                            <td class="status"><?php echo $serverrack09row['c_status']; ?></td>
                            <td class="condition"><?php echo $serverrack09row['c_condition']; ?></td>
                            <td class="storob"><?php echo $serverrack09row['storob']; ?></td>
                            <td class="remarks"><?php echo $serverrack09row['remarks']; ?></td>
            ...
            <section>
                <div class="card card2" id="wmfccRack1">
                    <table class="tableTitle">
                        <tr>
                            <td class="title"><h4>WMFCC Rack</h4></td>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <!-- Opening code for Fetching Data -->
                        <?php while ($wmfccrack09row = $wmfccrack09-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $wmfccrack09row['id']; ?></td>
                            <td class="componentName"><?php echo $wmfccrack09row['name']; ?></td>
                            <td class="status"><?php echo $wmfccrack09row['c_status']; ?></td>
                            <td class="condition"><?php echo $wmfccrack09row['c_condition']; ?></td>
                            <td class="storob"><?php echo $wmfccrack09row['storob']; ?></td>
                            <td class="remarks"><?php echo $wmfccrack09row['remarks']; ?></td>
                            <td class="action"><button class="btn btn-link updatebtn">Update</button></td>
                        </tr>
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <!-- Opening code for Fetching Data -->
                        <?php while ($radioroomrow09 = $radioroom09-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $radioroomrow09['id']; ?></td>
                            <td class="componentName"><?php echo $radioroomrow09['name']; ?></td>
                            <td class="status"><?php echo $radioroomrow09['c_status']; ?></td>
                            <td class="condition"><?php echo $radioroomrow09['c_condition']; ?></td>
                            <td class="storob"><?php echo $radioroomrow09['storob']; ?></td>
                            <td class="remarks"><?php echo $radioroomrow09['remarks']; ?></td>
                            <td class="action"><button class="btn btn-link updatebtn">Update</button></td>
                        </tr>
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <!-- Opening code for Fetching Data -->
                        <?php while ($wmfc109row = $wmfc109-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $wmfc109row['id']; ?></td>
                            <td class="componentName"><?php echo $wmfc109row['name']; ?></td>
                            <td class="status"><?php echo $wmfc109row['c_status']; ?></td>
                            <td class="condition"><?php echo $wmfc109row['c_condition']; ?></td>
                            <td class="storob"><?php echo $wmfc109row['storob']; ?></td>
                            <td class="remarks"><?php echo $wmfc109row['remarks']; ?></td>
                            <td class="action"><button class="btn btn-link updatebtn">Update</button></td>
                        </tr>
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <!-- Opening code for Fetching Data -->
                        <?php while ($wmfc209row = $wmfc209-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $wmfc209row['id']; ?></td>
                            <td class="componentName"><?php echo $wmfc209row['name']; ?></td>
                            <td class="status"><?php echo $wmfc209row['c_status']; ?></td>
                            <td class="condition"><?php echo $wmfc209row['c_condition']; ?></td>
                            <td class="storob"><?php echo $wmfc209row['storob']; ?></td>
                            <td class="remarks"><?php echo $wmfc209row['remarks']; ?></td>
                            <td class="action"><button class="btn btn-link updatebtn">Update</button></td>
                        </tr>
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <!-- Opening code for Fetching Data -->
                        <?php while ($lsdsystem09row = $lsdsystem09-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $lsdsystem09row['id']; ?></td>
                            <td class="componentName"><?php echo $lsdsystem09row['name']; ?></td>
                            <td class="status"><?php echo $lsdsystem09row['c_status']; ?></td>
                            <td class="condition"><?php echo $lsdsystem09row['c_condition']; ?></td>
                            <td class="storob"><?php echo $lsdsystem09row['storob']; ?></td>
                            <td class="remarks"><?php echo $lsdsystem09row['remarks']; ?></td>
                            <td class="action"><button class="btn btn-link updatebtn">Update</button></td>
                        </tr>
