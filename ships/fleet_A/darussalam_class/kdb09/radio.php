...
<html lang="en">
    ...
    <body>
        <?php require "../../../../00_function_scripts/individual_ship/kdb09/02_radio.php"; ?>
        ...
        <div class="card" id="card1">
            ...
            <h4 class="subheadline">RADIO STATUS</h4>
        </div>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../../00_function_scripts/individual_ship/kdb09/02_radio.php"; 
            ...
            if(isset($_POST['updatedata'])){
                ...
                $query = "UPDATE 00_radio_temporary SET r_status='$status_id', r_condition='$condition_id', storob='$storob_id', remarks='$remarks' WHERE id='$id'";
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="storob_id" id="storob_id">
                                        ...
                                        <option value="To KDB17">To KDB17</option>
                                        <option value="To KDB18">To KDB18</option>
                                        <option value="To KDB19">To KDB19</option>
                                        <option value="To KDB20">To KDB20</option>
                                        <option value="To KDB21">To KDB21</option>
        ...
        <section>
            <div class="card" id="card3">
                <table>
                    ...
                    <?php while ($radio09row = $radio09-> fetch_assoc()): ?>

                    <tr>
                        <td class="id"><?php echo $radio09row['id']; ?></td>
                        <td class="componentName"><?php echo $radio09row['radio_name']; ?></td>
                        <td class="status"><?php echo $radio09row['r_status']; ?></td>
                        <td class="condition"><?php echo $radio09row['r_condition']; ?></td>
                        <td class="storob"><?php echo $radio09row['storob']; ?></td>
                        <td class="remarks"><?php echo $radio09row['remarks']; ?></td>
