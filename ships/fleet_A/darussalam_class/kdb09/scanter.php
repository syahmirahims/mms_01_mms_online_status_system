...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../../../../01_stylesheets/08_ships_page/kdb09/03_style_radio_page.css">
    ...
    <body>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../../00_function_scripts/individual_ship/kdb09/03_scanter.php"; 
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <?php while ($antenna09row = $antenna09-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $antenna09row['id']; ?></td>
                            <td class="componentName"><?php echo $antenna09row['name']; ?></td>
                            <td class="status"><?php echo $antenna09row['c_status']; ?></td>
                            <td class="condition"><?php echo $antenna09row['c_condition']; ?></td>
                            <td class="storob"><?php echo $antenna09row['storob']; ?></td>
                            <td class="remarks"><?php echo $antenna09row['remarks']; ?></td>
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <!-- Opening code for Fetching Data -->
                        <?php while ($transceiver09row = $transceiver09-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $transceiver09row['id']; ?></td>
                            <td class="componentName"><?php echo $transceiver09row['name']; ?></td>
                            <td class="status"><?php echo $transceiver09row['c_status']; ?></td>
                            <td class="condition"><?php echo $transceiver09row['c_condition']; ?></td>
                            <td class="storob"><?php echo $transceiver09row['storob']; ?></td>
                            <td class="remarks"><?php echo $transceiver09row['remarks']; ?></td>
                            <td class="action"><button class="btn btn-link updatebtn">Update</button></td>
                        </tr>
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <!-- Opening code for Fetching Data -->
                        <?php while ($utilityrack09row = $utilityrack09-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $utilityrack09row['id']; ?></td>
                            <td class="componentName"><?php echo $utilityrack09row['name']; ?></td>
                            <td class="status"><?php echo $utilityrack09row['c_status']; ?></td>
                            <td class="condition"><?php echo $utilityrack09row['c_condition']; ?></td>
                            <td class="storob"><?php echo $utilityrack09row['storob']; ?></td>
                            <td class="remarks"><?php echo $utilityrack09row['remarks']; ?></td>
                            <td class="action"><button class="btn btn-link updatebtn">Update</button></td>
                        </tr>
