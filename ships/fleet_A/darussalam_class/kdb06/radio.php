...
<html lang="en">
    ...
    <body>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../../00_function_scripts/individual_ship/kdb06/02_radio.php"; 
        ...
        <section>
            <div class="card" id="card3">
                <table>
                    ...
                    <?php while ($radio06row = $radio06-> fetch_assoc()): ?>

                    <tr>
                        <td class="id"><?php echo $radio06row['id']; ?></td>
                        <td class="componentName"><?php echo $radio06row['radio_name']; ?></td>
                        <td class="status"><?php echo $radio06row['r_status']; ?></td>
                        <td class="condition"><?php echo $radio06row['r_condition']; ?></td>
                        <td class="storob"><?php echo $radio06row['storob']; ?></td>
                        <td class="remarks"><?php echo $radio06row['remarks']; ?></td>
