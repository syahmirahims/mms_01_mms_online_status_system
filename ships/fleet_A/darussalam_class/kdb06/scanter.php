...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../../../../01_stylesheets/08_ships_page/kdb06/03_style_radio_page.css">
    ...
    <body>
        <?php require "../../../../00_function_scripts/individual_ship/kdb06/03_scanter.php"; ?>
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <?php while ($antenna06row = $antenna06-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $antenna06row['id']; ?></td>
                            <td class="componentName"><?php echo $antenna06row['name']; ?></td>
                            <td class="status"><?php echo $antenna06row['c_status']; ?></td>
                            <td class="condition"><?php echo $antenna06row['c_condition']; ?></td>
                            <td class="storob"><?php echo $antenna06row['storob']; ?></td>
                            <td class="remarks"><?php echo $antenna06row['remarks']; ?></td>
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <!-- Opening code for Fetching Data -->
                        <?php while ($transceiver06row = $transceiver06-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $transceiver06row['id']; ?></td>
                            <td class="componentName"><?php echo $transceiver06row['name']; ?></td>
                            <td class="status"><?php echo $transceiver06row['c_status']; ?></td>
                            <td class="condition"><?php echo $transceiver06row['c_condition']; ?></td>
                            <td class="storob"><?php echo $transceiver06row['storob']; ?></td>
                            <td class="remarks"><?php echo $transceiver06row['remarks']; ?></td>
                            <td class="action"><button class="btn btn-link updatebtn">Update</button></td>
                        </tr>
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <!-- Opening code for Fetching Data -->
                        <?php while ($utilityrack06row = $utilityrack06-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $utilityrack06row['id']; ?></td>
                            <td class="componentName"><?php echo $utilityrack06row['name']; ?></td>
                            <td class="status"><?php echo $utilityrack06row['c_status']; ?></td>
                            <td class="condition"><?php echo $utilityrack06row['c_condition']; ?></td>
                            <td class="storob"><?php echo $utilityrack06row['storob']; ?></td>
                            <td class="remarks"><?php echo $utilityrack06row['remarks']; ?></td>
                            <td class="action"><button class="btn btn-link updatebtn">Update</button></td>
                        </tr>
