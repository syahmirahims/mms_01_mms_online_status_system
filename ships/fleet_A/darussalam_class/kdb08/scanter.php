...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../../../../01_stylesheets/08_ships_page/kdb08/03_style_radio_page.css">
    ...
    <body>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../../00_function_scripts/individual_ship/kdb08/03_scanter.php"; 
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <?php while ($antenna08row = $antenna08-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $antenna08row['id']; ?></td>
                            <td class="componentName"><?php echo $antenna08row['name']; ?></td>
                            <td class="status"><?php echo $antenna08row['c_status']; ?></td>
                            <td class="condition"><?php echo $antenna08row['c_condition']; ?></td>
                            <td class="storob"><?php echo $antenna08row['storob']; ?></td>
                            <td class="remarks"><?php echo $antenna08row['remarks']; ?></td>
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <!-- Opening code for Fetching Data -->
                        <?php while ($transceiver08row = $transceiver08-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $transceiver08row['id']; ?></td>
                            <td class="componentName"><?php echo $transceiver08row['name']; ?></td>
                            <td class="status"><?php echo $transceiver08row['c_status']; ?></td>
                            <td class="condition"><?php echo $transceiver08row['c_condition']; ?></td>
                            <td class="storob"><?php echo $transceiver08row['storob']; ?></td>
                            <td class="remarks"><?php echo $transceiver08row['remarks']; ?></td>
                            <td class="action"><button class="btn btn-link updatebtn">Update</button></td>
                        </tr>
            ...
            <section>
                ...
                <div class="card" id="card3">
                    <table>
                        ...
                        <!-- Opening code for Fetching Data -->
                        <?php while ($utilityrack08row = $utilityrack08-> fetch_assoc()): ?>

                        <tr>
                            <td class="id"><?php echo $utilityrack08row['id']; ?></td>
                            <td class="componentName"><?php echo $utilityrack08row['name']; ?></td>
                            <td class="status"><?php echo $utilityrack08row['c_status']; ?></td>
                            <td class="condition"><?php echo $utilityrack08row['c_condition']; ?></td>
                            <td class="storob"><?php echo $utilityrack08row['storob']; ?></td>
                            <td class="remarks"><?php echo $utilityrack08row['remarks']; ?></td>
                            <td class="action"><button class="btn btn-link updatebtn">Update</button></td>
                        </tr>
