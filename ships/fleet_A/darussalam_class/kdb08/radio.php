...
<html lang="en">
    ...
    <body>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../../00_function_scripts/individual_ship/kdb08/02_radio.php"; 
        ...
        <section>
            <div class="card" id="card3">
                <table>
                    ...
                    <?php while ($radio08row = $radio08-> fetch_assoc()): ?>

                    <tr>
                        <td class="id"><?php echo $radio08row['id']; ?></td>
                        <td class="componentName"><?php echo $radio08row['radio_name']; ?></td>
                        <td class="status"><?php echo $radio08row['r_status']; ?></td>
                        <td class="condition"><?php echo $radio08row['r_condition']; ?></td>
                        <td class="storob"><?php echo $radio08row['storob']; ?></td>
                        <td class="remarks"><?php echo $radio08row['remarks']; ?></td>
