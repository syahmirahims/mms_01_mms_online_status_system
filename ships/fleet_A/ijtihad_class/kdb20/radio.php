...
<html lang="en">
    ...
    <body>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../../00_function_scripts/individual_ship/kdb20/01_radio.php"; 
        ...
        <section>
            <div class="card" id="card3">
                <table>
                    ...
                    <?php while ($radio20row = $radio20-> fetch_assoc()): ?>

                    <tr>
                        <td class="id"><?php echo $radio20row['id']; ?></td>
                        <td class="componentName"><?php echo $radio20row['radio_name']; ?></td>
                        <td class="status"><?php echo $radio20row['r_status']; ?></td>
                        <td class="condition"><?php echo $radio20row['r_condition']; ?></td>
                        <td class="storob"><?php echo $radio20row['storob']; ?></td>
                        <td class="remarks"><?php echo $radio20row['remarks']; ?></td>
