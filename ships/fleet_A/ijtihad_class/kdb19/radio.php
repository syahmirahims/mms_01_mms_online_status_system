...
<html lang="en">
    ...
    <body>
        <?php require "../../../../00_function_scripts/individual_ship/kdb19/01_radio.php"; ?>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../../00_function_scripts/individual_ship/kdb19/01_radio.php"; 
        ...
        <section>
            <div class="card" id="card3">
                <table>
                    ...
                    <?php while ($radio19row = $radio19-> fetch_assoc()): ?>

                    <tr>
                        <td class="id"><?php echo $radio19row['id']; ?></td>
                        <td class="componentName"><?php echo $radio19row['radio_name']; ?></td>
                        <td class="status"><?php echo $radio19row['r_status']; ?></td>
                        <td class="condition"><?php echo $radio19row['r_condition']; ?></td>
                        <td class="storob"><?php echo $radio19row['storob']; ?></td>
                        <td class="remarks"><?php echo $radio19row['remarks']; ?></td>
