...
<html lang="en">
    ...
    <body>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../../00_function_scripts/individual_ship/kdb18/01_radio.php"; 
        ...
        <section>
            <div class="card" id="card3">
                <table>
                    ...
                    <?php while ($radio18row = $radio18-> fetch_assoc()): ?>

                    <tr>
                        <td class="id"><?php echo $radio18row['id']; ?></td>
                        <td class="componentName"><?php echo $radio18row['radio_name']; ?></td>
                        <td class="status"><?php echo $radio18row['r_status']; ?></td>
                        <td class="condition"><?php echo $radio18row['r_condition']; ?></td>
                        <td class="storob"><?php echo $radio18row['storob']; ?></td>
                        <td class="remarks"><?php echo $radio18row['remarks']; ?></td>
