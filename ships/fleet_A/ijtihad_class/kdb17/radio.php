...
<html lang="en">
    ...
    <body>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../../00_function_scripts/individual_ship/kdb17/01_radio.php"; 
        ...
        <section>
            <div class="card" id="card3">
                <table>
                    ...
                    <?php while ($radio17row = $radio17-> fetch_assoc()): ?>

                    <tr>
                        <td class="id"><?php echo $radio17row['id']; ?></td>
                        <td class="componentName"><?php echo $radio17row['radio_name']; ?></td>
                        <td class="status"><?php echo $radio17row['r_status']; ?></td>
                        <td class="condition"><?php echo $radio17row['r_condition']; ?></td>
                        <td class="storob"><?php echo $radio17row['storob']; ?></td>
                        <td class="remarks"><?php echo $radio17row['remarks']; ?></td>
