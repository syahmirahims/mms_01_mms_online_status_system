...
<html lang="en">
    ...
    <body>
        ...
        <div class="card" id="card1">
            <h2 class="headline">IJTIHAD CLASS</h2>
        </div>

        <div class="row" id="card2">
            <div class="column">
                <div class="card" id="minicard">
                    <a href="kdb17/home.php">
                        <img src="../../../images/16_round_17_pennant_number.png" alt="C2 System">
                        <br>
                        <h3 class="card-headline">KDB17</h3>
                        <p>Ijtihad</p>
                    </a>
                </div>
            </div>
            ...
            <div class="column">
                <div class="card" id="minicard">
                    <a href="kdb18/home.php">
                        <img src="../../../images/17_round_18_pennant_number.png" alt="Radio">
                        <br>
                        <h3 class="card-headline">KDB18</h3>
                        <p>Berkat</p>
                    </a>
                </div>
            </div>
            ...
            <div class="column">
                <div class="card" id="minicard">
                    <a href="kdb19/home.php">
                        <img src="../../../images/18_round_19_pennant_number.png" alt="PV80">
                        <br>
                        <h3 class="card-headline">KDB19</h3>
                        <p>Syafaat</p>
                    </a>
                </div>
            </div>
            ...
            <div class="column">
                <div class="card" id="minicard">
                    <a href="kdb20/home.php">
                        <img src="../../../images/19_round_20_pennant_number.png" alt="Radio">
                        <br>
                        <h3 class="card-headline">KDB20</h3>
                        <p>Afiat</p>
                    </a>
                </div>
            </div>
