...
<html lang="en">
    ...
    <body>
        ...
        <!-- ###################################################### -->
        <?php 
            require "../../../00_function_scripts/individual_ship/noc/01_radio.php"; 
        ...
        <section>
            <div class="card" id="card3">
                <table>
                    ...
                    <?php while ($radioNOCrow = $radioNOC-> fetch_assoc()): ?>

                    <tr>
                        <td class="id"><?php echo $radioNOCrow['id']; ?></td>
                        <td class="componentName"><?php echo $radioNOCrow['radio_name']; ?></td>
                        <td class="status"><?php echo $radioNOCrow['r_status']; ?></td>
                        <td class="condition"><?php echo $radioNOCrow['r_condition']; ?></td>
                        <td class="storob"><?php echo $radioNOCrow['storob']; ?></td>
                        <td class="remarks"><?php echo $radioNOCrow['remarks']; ?></td>
