...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../01_stylesheets/08_ships_page/01_style_home_page.css">
    ...
    <body>
        ...
        <div class="row" id="card2">
            ...
            <div class="column">
                <div class="card" id="minicard">
                    <a href="on_shore/home.php">
                        <img src="../images/07_round_shorebase_outline.png" alt="PV80">
                        <br>
                        <h3 class="card-headline">On Shore</h3>
                    </a>
                </div>
            </div>
        </div>
