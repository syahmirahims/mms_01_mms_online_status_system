...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="01_stylesheets/03_home_page/01_style_home_page.css">
    ...
    <body>
        <div class="sidenav">
            ...
            <a href="home.php"><i class="fas fa-tachometer-alt" id="current"></i></a> <br><br>
        ...
        <div class="card" id="card1">
            <h2 class="headline">WELCOME TO MMS ONLINE STATUS SYSTEM</h2>
        </div>

        <div class="card" id="card2">
            <img class="under_construction" src="images/26_site_under_construction_2.png" alt="Page Under Construction">
        </div>
    </body>
</html>