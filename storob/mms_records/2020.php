...
<html lang="en">
    <head>
        ...
        <title>Storob Tracker 2020</title>
    ...
    <body>
        ...
        <div class="card card2" id="antenna">
            <table class="tableTitle">
                <tr>
                    <td class="title"><h4>Storob Record 2020</h4></td>
        ...
        <div class="card" id="card3">
            <table>
                ...
                <?php while ($strow2020 = $storobTracker2020-> fetch_assoc()): ?>

                <tr>
                    <td class="id"><?php echo $strow2020['id']; ?></td>
                    <td class="jobcardStatus"><?php echo $strow2020['jobcard_status']; ?></td>
                    <td class="storobId"><?php echo $strow2020['storob_id']; ?></td>
                    <td class="componentName"><?php echo $strow2020['component']; ?></td>
                    <td class="fromShip"><?php echo $strow2020['ship_from']; ?></td>
                    <td class="toShip"><?php echo $strow2020['ship_to']; ?></td>
                    <td class="date"><?php echo $strow2020['date_raised']; ?></td>
                    <td class="reference"><?php echo $strow2020['jobcard_no']; ?></td>
